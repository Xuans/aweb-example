    ...
    (function (factory) {
        if (typeof define === 'function') {
            if (define.amd) {
                ...
                window.wangEditor=factory(window.$);
                // }
            } else if (define.cmd) {
                // CMD模式
            ...
            Menu.fn.changeSelectedState = function (state) {
                ...
                if (state != null && typeof state === 'boolean') {
                    ...
                    if (state) {
                        // 选中
                        self.$domNormal.hide();
                        self.$domSelected.css('display','block');
                    } else {
                        // 未选中
                        self.$domNormal.show();
                        self.$domSelected.css('display','none');
                    }
                } // if
            };
        ...
        _e(function (E, $) {
            ...
            Txt.fn.updateValueEvent = function () {
                ...
                function doOnchange() {
                    ...
                    // 触发 onchange 事件
                    if (editor.onchange && typeof editor.onchange === 'function') {
                        editor.onchange.call(editor, val);
                    }
                ...
                fns.onload || (fns.onload = function (resultText, xhr) {
                    ...
                    if (resultText.indexOf('error|') === 0) {
                        ...
                        img.onerror = function () {
                            E.error('使用返回的结果获取图片，发生错误。请确定以下结果是否正确：' + resultText);
                            img = null;
                        };
                        img.src = resultText;
                    }
        ...
        _e(function (E, $) {
            ...
            E.plugin(function () {
                ...
                function insertImg(src, event) {
                    ...
                    img.onerror = function () {
                        E.error('使用返回的结果获取图片，发生错误。请确定以下结果是否正确：' + src);
                        img = null;
                    };
                    img.src = src;
                }
                ...
                reader.onload = function (e) {
                    ...
                    editor.xhrUploadImg({
                        ...
                        loadfn: function (resultText, xhr) {
                            ...
                            // 执行配置中的方法
                            var editor = this;
                            onload.call(editor, editor,resultText, xhr);
                        },
