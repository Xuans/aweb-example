 ...
 */
(function (d) {
    "function" === typeof define && define.amd ? define(["jquery", "jquery.dataTables"], function (q) {
    ...
    d.extend(m.prototype, {
        fnUpdate: function () {
            ...
            0 < this.s.iRightColumns && (e = b.right.wrapper, e.style.width = (h + 6) + "px", e.style.height = "1px", this.s.rtl ?
            ...
            for (var b = [], c = 0,
                     d = a.childNodes.length; c < d; c++)"TR" == a.childNodes[c].nodeName.toUpperCase() &&
            ...
            if (!("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)) {
                ...
                a.outerHeight();
                a.height();
                for (var g = this._fnGetTrNodes(g), b = this._fnGetTrNodes(c), h = [], c = 0,
                         a = b.length; c < a; c++)e = g[c].offsetHeight, f = b[c].offsetHeight, e = f > e ? f : e, "semiauto" == this.s.sHeightMatch && (g[c]._DTTC_iHeight = e), h.push(e);
                c = 0;
