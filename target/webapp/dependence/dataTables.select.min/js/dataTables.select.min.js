...
*/
(function(e) {
    "function" === typeof define && define.amd ? define(["jquery", "jquery.dataTables"], function(j) {
        return e(j, window, document)
    }) : "object" === typeof exports ? module.exports = function(j, l) {
        j || (j = window);
        if (!l || !l.fn.dataTable)
            l = require("jquery.dataTables")(j, l).$;
            ...
            if (!j.getSelection || !j.getSelection().toString()) {
                ...
                b.table().container()) {
                    ...
                    if (g.any()) {
                        ...
                        i(b, h, [c, g, a]);
                        h.isDefaultPrevented() || (h = g.index(),
                        "row" === c ? (c = h.row,
                        s(a, b, d, "row", c)) : "column" === c ? (c = g.index().column,
                        s(a, b, d, "column", c)) : "cell" === c && (c = g.index(),
                        s(a, b, d, "cell", c)),
    ...
    c, a, d) {
        if (!d || b.flatten().length)
            ...
            a.unshift(b),
            e(b.table().node()).triggerHandler(c, a)
    }
    function y(b) {
        var c = b.settings()[0];
    ...
    function z(b, c, a, d) {
        ...
        if (!b[c + "s"]({
            ...
            f.splice(e.inArray(a, f) + 1, f.length);
        else {
            if (d > m)
                var k = m
                  , m = d
        ...
        b[c](a, {
            selected: !0
        }).any() ? (f.splice(e.inArray(a, f), 1),
        b[c + "s"](f).deselect()) : b[c + "s"](f).select()
    }
    function p(b, c) {
        if (c || "single" === 
        b._select.style) {
    ...
    function s(b, c, a, d, f) {
        ...
        k && 1 === b.flatten().length ? c[d](f).deselect() : (b.deselect(),
        c[d](f).select())) : "multi+shift" == e ? b.shiftKey ? 
    ...
    g.select.init = function(b) {
        ...
        if (!0 === a)
            ...
            f = a,
            i = !0;
        else if (e.isPlainObject(a) && (a.blurable !== h && (m = a.blurable),
        a.info !== h && (k = a.info),
        a.items !== h && (d = a.items),
        a.style !== h && (f = a.style,
        i = !0),
        a.selector !== h && (w = a.selector),
        a.className !== h))
            j = a.className;
        b.select.selector(w);
        b.select.items(d);
    ...
    e.each([{
        ...
        g.ext.selector[c.type].push(function(a, b, f) {
            ...
            for (var g = 0, i = f.length; g < i; g++)
                e = a[c.prop][f[g]],
                (!0 === b && !0 === e._select_selected || !1 === b && !e._select_selected) && k.push(f[g]);
            return k
        })
    });
    g.ext.selector.cell.push(function(b, c, a) {
        ...
        for (var e = 0, g = a.length; e < g; e++)
            d = b.aoData[a[e].row],
            (!0 === c && d._selected_cells && !0 === d._selected_cells[a[e].column] || !1 === c && (!d._selected_cells || !d._selected_cells[a[e].column])) && f.push(a[e]);
        return f
    });
            ...
            if (!c._select_init) {
                ...
                c.aoRowCreatedCallback.push({
                    fn: function(a, b, d) {
                        ...
                        a = 0;
                        for (d = c.aoColumns.length; a < d; a++)
                            (c.aoColumns[a]._select_selected || b._selected_cells && b._selected_cells[a]) && e(b.anCells[a]).addClass(c._select.className)
                    },
