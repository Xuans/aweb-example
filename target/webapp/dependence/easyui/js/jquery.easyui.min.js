    ...
    function _3dd(_3de, _3df) {
        ...
        function _3e4() {
            ...
            if (_3df == "east" && _3e0.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3e5.top, height: _3e5.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3df == "west" && _3e0.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3e5.top, height: _3e5.height},
                        expand: {left: 0}
                    };
                } else {
...
(function ($) {
    ...
    function _4ec(_4ed, _4ee) {
        ...
        if (opts.height == "auto") {
            _4f2.css({margin: "", paddingTop: "", paddingBottom: "", height: "30", lineHeight: ""});
        }
        tb._size(opts, _4f0);
        ...
        _4f4.css({width: (opts.iconWidth + 10) + "px", height: _4f7 + "px"});
        _4f2.css({
        ...
        if (opts.multiline) {
            _4f2.css({paddingTop: (_4ed.style.paddingTop || ""), paddingBottom: (_4ed.style.paddingBottom || "0")});
            _4f2._outerHeight(_4f7);
        } else {
            _4f2.css({height: _4f7 + "px", lineHeight: _4f7 + "px"});
        }
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        revealed: false,
        showEye: true,
        inputEvents: {focus: _543, blur: _547},
        val: function (_550) {
    ...
    function _9ff(_a00) {
        ...
        if (_a01.is(":visible")) {
            ...
            if (_a02 != _a00) {
                ...
                $(_a00).next().first().addClass("p-show");
            } else {
                $(_a00).next().first().removeClass("p-show");
            }
        } else {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        panelEvents: {mouseover: _a70, mouseout: _a71, click: _a72, scroll: _a75},
