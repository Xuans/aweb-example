...
(function( factory ) {
	...
	function _fnCreateTr ( oSettings, iRow, nTrIn, anTds )
	{
		...
		if ( row.nTr === null )
		{
			...
			for ( i=0, iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
				...
				if(nTd.innerText && oCol.bVisible){
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			for ( i=0 ; i<visibleColumns.length ; i++ ) {
				...
				if(headerCells[i]){
					headerCells[i].style.minWidth = column.sWidthOrig !== null && column.sWidthOrig !== '' ?
						_fnStringToCss( column.sWidthOrig ) :
						'';
				}else{
					//FIXED Do nothing while hide some columns with refresh from server
					//By lijiancheng@agree.com.cn on 20190116
				}
        ...
        // bCloseAutoWidth  是自定义的参数，让表格自动计算宽度的可配置,true就是关闭，false就是开
		if ( tableWidthAttr &&  !oSettings.bCloseAutoWidth) {
	...
	$.extend( DataTable.ext.classes, {
		...
		/* Filtering */
		"sFilterInput": "search-query input-small",
	
		/* Page length */
		"sLengthSelect": "input-small",
